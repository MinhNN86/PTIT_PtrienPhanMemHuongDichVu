...
#### 3. Tra cứu sinh viên theo lớp

- **Method**: `GET`
- **URL**: `http://localhost:8080/api/students?courseId=1`
- **Mô tả**: Lấy danh sách tất cả sinh viên trong lớp có ID = 1
...
| **GET**    | `/api/students?courseId={id}`      | Tra cứu sinh viên theo lớp | Không        |
| **GET**    | `/api/students?studentCode={code}` | Tra cứu sinh viên theo mã  | Không        |
